    ...
    <body>
        ...
        <header class="l-header">
            <nav class="nav bd-grid">
                <div>
                    <a href="#" class="nav__logo">Shristi</a>
                </div>
        ...
        <main class="l-main">
            ...
            <section class="home bd-grid" id="home">
                <div class="home__data">
                    <h1 class="home__title">Hi,<br>I'am <span class="home__title-color">Shristi</span><br>ECE Undergraduate</h1>

                    <a href="#contact" class="button">Contact</a>
                </div>

                <div class="home__social">
                    <a href="https://www.linkedin.com/in/-setia-1b99081b7/" class="home__social-icon"><i class='bx bxl-linkedin'></i></a>
                    <!-- <a href="" class="home__social-icon"><i class="fa fa-youtube-play"></i></a>-->
                    <a href="https://github.com/shristi47" class="home__social-icon"><i class='bx bxl-github' ></i></a>
                </div>
            ...
            <section class="about section " id="about">
                ...
                <div class="about__container bd-grid">
                    ...
                    <div>
                        <h2 class="about__subtitle">I'am Shristi</h2>
                        <p class="about__text">Currently persuing B.Tech. in ECE from National Institute of Technology Agartala.
                        <br><br>I have keen interst and knowledge in the field of web development. I have good coding skills and have learnt programming languages like  C, C++, python. I'm actively looking for a job for web developer or software developer roles.</p>           
                    </div>                                   
                </div>
            </section>
            ...
            <section class="contact section" id="contact">
                ...
                <div class="contact__container bd-grid">
                    <!-- <form action="" class="contact__form">
                        ...
                        <a href="https://github.com/priyanshi47">
                        ...
                        <a href="https://www.linkedin.com/in/priyanshi-setia-1b99081b7/">
                        ...
                        <a href="mailto:setia9@gmail.com"><input type="button" value="Send Mail" class="contact__button button" style="background-color:skyblue ; border:2px solid black; color:black ; width:500px"></a>
        ...
        <!--===== FOOTER =====-->
        <footer class="footer">
            <p class="footer__title">Shristi Sarkar </p>
